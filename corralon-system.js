  ...
  const FALTANTES = (() => {
    ...
    function rowFromRemote(item) {
      return {
        ...
        pedidoOrigenId: item.pedido_origen_id || '',
        pedidoOrigenDocId: item.pedido_origen_doc_id || '',
        pedidoRowUid: item.pedido_row_uid || '',
    ...
    function rowToRemote(row, orden = 0, syncId = 0) {
      ...
      return {
        ...
        pedido_origen_id: row.pedidoOrigenId || '',
        pedido_origen_doc_id: row.pedidoOrigenDocId || '',
        pedido_row_uid: row.pedidoRowUid || '',
